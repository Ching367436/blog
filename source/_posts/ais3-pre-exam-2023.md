...
categories:
  - [AIS3, Pre-exam]
typora-root-url: ./ais3-pre-exam-2023
excerpt: 今年來幫 AIS3 Pre-exam 來出題，共出了 1 題 crypto（2DES），3 題 web（Login Panel, E-Portfolio, E-Portfolio baby），裡面是我的 write-up。
cover: /ais3-pre-exam-2023-write-up/myfirstctf-staff.png
photos:
  - /ais3-pre-exam-2023-write-up/myfirstctf-staff.png
---
...
<img src="./meet-in-the-middle.svg" style="width: 100%;" />
...
不過還有一個問題：存 $2^{32}$ 種可能的 middle 會耗掉太多空間然後噴錯（有人還把這個做成[梗圖](./2des-meme.png)）。
...
這個 payload 也可以通過第 6 行的檢查，所以就能成功登進去 `admin` 的帳戶了。有人一直繞不過第 6 行的檢查還被做成[梗圖](./login-panel-meme.png)。
...
另外在 MyFirstCTF 結束後我有上台分享大家都在 portfolio 裡面放了什麼，那份簡報在[這裡](./My%20First%20CTF%202023.pdf)。
