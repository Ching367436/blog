...
![Eta reply](./eta-reply.png)

又隔了兩天 Github 發給了這個洞 `CVE-2023-23630` 。

> GitHub has issued `CVE-2023-23630` for this Security Advisory after reviewing it for compliance with CVE rules. Since you've already published this Security Advisory, we'll publish this CVE to the [CVE List](https://cve.mitre.org/cve/).
>
...
2023/1/28: Eta 釋出 v2.0.0 修補了漏洞。

2023/1/30: Github 發給了這個漏洞 `CVE-2023-23630`。
